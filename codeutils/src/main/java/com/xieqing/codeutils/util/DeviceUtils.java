...
public final class DeviceUtils {
    ...
    public static String getOnlyAndroidId() {
        ...
        try {
            ...
            //API>=9 使用serial号
            s = new UUID(m_szDevIDShort.hashCode(), serial.hashCode()).toString();
    ...
    public static String getMessage() {
        ...
        try {
            ...
            jsonObject.put("pixel",ScreenUtils.getScreenHeight()+"*"+ScreenUtils.getScreenWidth());
    ...
    public static String getAllMessage() {
        ...
        try {
            ...
            jsonObject.put("info",PhoneUtils.getPhoneStatus());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return jsonObject.toString();
    ...
    public static String getBuildVersionName(int sdk) {
        switch (sdk){
            case 19:
                return "4.4";
            case 20:
