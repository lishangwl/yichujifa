...
public abstract class PickerView<S extends PickerView.SavedState> extends LinearLayout
        implements OnColorPickedListener<PickerView>, ActivityRequestHandler {
