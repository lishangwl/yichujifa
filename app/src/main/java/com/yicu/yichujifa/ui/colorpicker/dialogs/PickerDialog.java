package com.yicu.yichujifa.ui.colorpicker.dialogs;
...
import com.yicu.yichujifa.ui.colorpicker.interfaces.ActivityRequestHandler;
import com.yicu.yichujifa.ui.colorpicker.interfaces.ActivityResultHandler;
import com.yicu.yichujifa.ui.colorpicker.interfaces.OnColorPickedListener;
import com.yicu.yichujifa.ui.colorpicker.interfaces.PickerTheme;
...
abstract class PickerDialog<T extends PickerDialog> extends AppCompatDialogFragment implements OnColorPickedListener<PickerView>,
        ActivityRequestHandler, PickerTheme {
    ...
    public void onResume() {
        ...
        window.setLayout(
                Math.min(SizeUtils.dp2px(displayMetrics.widthPixels > displayMetrics.heightPixels ? 800 : 500),
        ...
        window.setBackgroundDrawable(new InsetDrawable(drawable, SizeUtils.dp2px(12)));
    }
    ...
    public float getCornerRadius() {
        return SizeUtils.dp2px(cornerRadius);
    }
