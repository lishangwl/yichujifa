...
public class ActionsFragment extends BaseFragment{
    ...
    private void refresh() {
        ...
        new Thread(() -> {
                ...
                ycfList.addAll(ActionHelper.searchAllActionAndDirectory(currentDir));
    ...
    public ActionsFragment setOnActionSelectedListener(OnActionSelectedListener onActionSelectedListener) {
