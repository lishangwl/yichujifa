...
public class HomeCommunityFragment extends BaseFragment implements ActivityResultListener, Toolbar.OnMenuItemClickListener, FragmentOnKeyListener, SearchView.OnQueryTextListener{
    ...
    protected void onFragmentInit() {
        ...
        Objects.requireNonNull(tabLayout.getTabAt(0)).setText("社区");
