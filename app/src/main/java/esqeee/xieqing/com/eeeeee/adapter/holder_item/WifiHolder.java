...
public class WifiHolder extends BaseHolder{
    ...
    public WifiHolder(Context context, MyAdapter adapter) {
        super(context,R.layout.holder_wifi,adapter);
    }
    ...
    public void onBind(JSONBean jsonBean) {
        ...
        requestTime(true);
        aSwitch.setOpened(jsonBean.getInt("actionType") == 18);
        aSwitch.setOnClickListener(v->{
            PhoneUtils.vibrateShort();
            jsonBean.put("actionType",aSwitch.isOpened()?18:19);
        });
    }
