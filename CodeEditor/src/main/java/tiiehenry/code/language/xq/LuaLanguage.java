package tiiehenry.code.language.xq;
...
public class LuaLanguage extends Language {
	...
	private final static String keywordTarget ="且|break|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|then|true|until|while";
